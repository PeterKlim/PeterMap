//
//  ●	MapVC ●	MapVC MapVCViewController.swift
//  Klimov_maps
//
//  Created by WSR on 25.01.2021.
//
...
class MapVc: UIViewController,CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    MKAnnotationView?{
        if annotation.coordinate.longitude != mapView.userLocation.coordinate.latitude && annotation.coordinate.latitude !=
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLovations locations: [CLLocation]){
        ...
        func pointsPositisionalCollege(){
            ...
            let arrayName = ["ЦМКТ", "ЦПиРБ", "ЦАВТ", "ЦТЭК"]
